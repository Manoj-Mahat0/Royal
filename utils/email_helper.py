...
def send_email(to_email: str, to_name: str, subject: str, message: str):
    html_template = f"""
    <html>
    <body style="font-family: Arial, sans-serif; background-color: #fff7f9; padding: 20px;">
        <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
            ...
            <div style="padding: 20px; text-align: center;">
                ...
                <img src="https://cdn-icons-png.flaticon.com/512/3062/3062634.png" alt="Welcome" width="100"/>
                <p style="margin-top: 30px;">- From <strong>Cake Shop</strong></p>
            </div>
        </div>
    </body>
    </html>
